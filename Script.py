...
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇ Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Oʀ Jᴏɪɴ Us @REQUEST_MOvizz </b>"""
    
    HELP_TXT = "Hᴇʏ {}\nHᴇʀᴇ Mꜱ Mʏ Hᴇʟᴩ"

    ABOUT_TXT = """<b>✯ Mʏ ɴᴀᴍᴇ: {}
✯ Dᴇᴠᴇʟᴏᴩᴇʀ: <a herf=https://telegram.dog/REQUEST_MOvizz>REQUEST MOvizz..</a>
✯ Cᴏᴅᴇᴅ Oɴ: ᴩʏᴛʜᴏɴ/ᴩʏʀᴏɢʀᴀᴍ
✯ Mʏ DᴀᴛᴀBᴀꜱᴇ: ᴍᴏɴɢᴏ-ᴅʙ
✯ Mʏ Sᴇʀᴠᴇʀ: ᴀɴʏᴡʜᴇʀᴇ"""
   
    SOURCE_TXT = """<b>NOTE:</b>
No Source Join› :<a href=https://telegram.dog/REQUEST_MOvizz>REQUEST MOvizz..</a>

<b>ᴅᴇᴠ: <a herf=https://telegram.dog/REQUEST_MOvizz>REQUEST MOvizz..</a></b>"""
...
<b>⪼ EG:</b>
</code>/batch https://telegram.dog/REQUEST_MOvizz</code>"""
...
Fʀᴇᴇ Dɪꜱᴋ: {}"""
    ...
    WELCOM_TEXT = """Hᴇʏ {user} 💞 Wᴇʟᴄᴏᴍᴇ ᴛᴏ {chat}. ꜱʜᴀʀᴇ & ꜱᴜᴩᴩᴏʀᴛ, ʀᴇqᴜᴇꜱᴛ ʏᴏᴜ ᴡᴀɴᴛᴇᴅ ᴍᴏᴠɪᴇꜱ"""
