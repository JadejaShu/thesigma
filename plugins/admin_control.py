...
async def savegroup_and_welcome(bot, message):
    ...
    if bot.id in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            buttons = [[InlineKeyboardButton('Sᴜᴩᴩᴏʀᴛ', url=f'https://telegram.dog/{SUPPORT_CHAT}')]]
        ...
        buttons = [[InlineKeyboardButton('Hᴇʟᴩ', url=f"https://telegram.dog/{temp.U_NAME}?start=help")]]
