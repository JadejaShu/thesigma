...
PICS = (environ.get('PICS' ,'https://graph.org/file/48d6e22d9be393d294d8f.jpg https://graph.org/file/48d6e22d9be393d294d8f.jpg')).split()
UPTIME = time.time()
...
auth_channel = environ.get('AUTH_CHANNEL',"REQUEST_MOvizz")
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Nataliermvzz:QOiuh213MSIK@natalie.if4691m.mongodb.net/")
DATABASE_NAME = environ.get('DATABASE_NAME', "Natalie")
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/48d6e22d9be393d294d8f.jpg https://graph.org/file/48d6e22d9be393d294d8f.jpg")
...
# url shortner
SHORT_URL = "https://mdiskshortner.link"
SHORT_API = "bc3880c446991d4007f7c9e019097cb52d211de7"

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', "-1001824702648"))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001824702648')).split()]
MELCOW_NEW_USERS = is_enabled(environ.get('MELCOW_NEW_USERS', "True"), True)
PROTECT_CONTENT = is_enabled(environ.get('PROTECT_CONTENT', "Talse"), False)
